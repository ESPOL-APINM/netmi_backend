...
class napalmapi(object):
    def __init__(self, driver=None, hostname=None, username=None, password=None, optional_args=None):
        driver = napalm.get_network_driver(driver=driver)
